...
# Padrões de IA
ai_patterns = [
    "PIC*", "PersonalImageClassifier*", "Look*", "LookExtension*", "ChatBot", "ImageBot", "TMIC","Gemini*","Llama*","TeachableMachine*","ML4K*","Thunkable","Imagerecognizer","tmsoftwareinc*","YOLO*","EdgeLens","RecyLink","YOLOOD","ONNXICE",
